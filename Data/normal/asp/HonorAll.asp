...
OOO00.write("<script>alert(""参数错误""); history.go(-1);</script>")
OOO00.End
End If
...
OOO00.write("<script>alert(""暂无信息""); history.go(-1);</script>")
OOO00.End
else
pages= (77 * 50 - 3841)
rscp.pagesize=pages
...
<div class="content_top"><span>您当前位置：<a href="/">首页</a>&nbsp;&gt;&nbsp;荣誉展示</span>荣誉展示</div>
<div class="info_box">
