...
<div class="content_top"><span>您当前位置：<a href="/">首页</a>&nbsp;&gt;&nbsp;荣誉展示&nbsp;&gt;&nbsp;正文</span>   荣誉展示</div>
<div class="info_box">
<div class="Honorxx">
...
<a href="Honor.asp?id=<%=rs("id")%>">上一篇:<%=rs("Honorname")%></a>
<%else%>
...
<a class='next' href="Honor.asp?id=<%=rs1("id")%> ">下一篇:<%=rs1("Honorname")%></a>
<%else%>
