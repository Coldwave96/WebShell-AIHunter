...
OO0O0.Write("<title>产品管理</title>" & vbCrLf)
...
OO0O0.Write("          <tr>" & vbCrLf)
OO0O0.Write("            <td height=""35"" align=""left"" nowrap=""nowrap""><font size=2><b class=""pl15"">产品搜索</b>" & vbCrLf)
OO0O0.Write("                <select name=""menu1"" onchange=""MM_jumpMenu('self',this,0)"">" & vbCrLf)
OO0O0.Write("                  <option>--按产品类别搜索--</option>" & vbCrLf)
OO0O0.Write("                  <option value=""admin_Product.asp"">查看全部大类</option>" & vbCrLf)
OO0O0.Write("                  ")
...
OO0O0.Write("    <th width=""250""> 产品名称</th>" & vbCrLf)
OO0O0.Write("    <th width=""120"">产品分类</th>" & vbCrLf)
OO0O0.Write("    <th width=""100"">加入时间</th>" & vbCrLf)
OO0O0.Write("    <th width=""100"">缩图</th>" & vbCrLf)
...
OO0O0.Write("      <td><input type=""button"" class=""btn btn82 btn_del"" name=""button"" value=""删除"" onClick=""javascript:if(confirm('亲：确定删除？删除后不可恢复!')){window.location.href='?id=")
OO0O0.Write rs("id")
...
Else
OO0O0.Write "<li><a href=""?Page=1&leixing="&OO00OO("leixing")&"&keyword="&OO00OO("keyword")&"&ClassID="& OO00OO("classID") &""">首 页</a></li>"
OO0O0.Write "<li><a href=""?Page="& Page- (106 * 34 - 3603) &"&leixing="&OO00OO("leixing")&"&keyword="&OO00OO("keyword")&"&ClassID="& OO00OO("classID") &""">上一页</a></li>"
End If
If Rs.PageCount-Page< (106 * 34 - 3603) Then
OO0O0.Write "<li class=""disabled""><span>下一页</span></li><li class=""disabled""><span>尾 页</span></li>"
Else
OO0O0.Write "<li><a href=""?Page="& Page+ (106 * 34 - 3603) &"&leixing="&OO00OO("leixing")&"&keyword="&OO00OO("keyword")&"&ClassID="& OO00OO("classID") &""">下一页</a></li> "
OO0O0.Write "<li><a href=""?Page="& Rs.PageCount &"&leixing="&OO00OO("leixing")&"&keyword="&OO00OO("keyword")&"&ClassID="& OO00OO("classID") &""">尾 页</a></li>"
End If
...
rs.delete
rs.update
OO0O0.Write "<script>alert('当前信息删除成功！');window.location.href='admin_Product.asp';</script>"
end if
If OO00OO("action")="px" Then
OO0O0.Write "<script>alert('免费版暂不支持排序\n数字越大越排前!');window.location.href='admin_Product.asp';</script>"
end if
conn.close
set conn=nothing
%>