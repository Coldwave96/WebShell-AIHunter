...
<%
current_navigation = "cms_content_add"
If inull(rq("cid")) Or Not IsNumeric(rq("cid")) Then
	cid = 0
Else
	cid = Int(rq("cid"))
End If
Call check_admin_purview("cms_content_add")
If Not inull(rf("save")) Then 
Set rs = ado_mquery("select * from cms_content")
rs.AddNew
rs("c_name") = rf("c_name")
...
rs.Update
rs("c_fname") = rs("id")
rs("c_order") = iif(rf("c_order")=0,rs("id"),rf("c_order"))
rs.Update
rs.Close
Set rs = Nothing
Call alert_href("添加成功","cms_content_add.asp?cid="&rf("c_parent")&"")
End If 
%>
...
<div id="content_main">
	...
	<div id="content">
		...
		<div id="right">
			<div class="content_h pl10">添加信息</div>
					...
					<div class="l10">
						<div class="x8">
							<div class="form-group">
								...
								<div class="field">
									<input id="c_name" class="input" type="text" name="c_name" value="" placeholder="请填写内容标题" data-validate="required:必填"/>
								</div>
						...
						<div class="x2">
							<div class="form-group">
								...
								<div class="field">
									<input id="c_color" class="input" type="text" name="c_color" value="" />
								</div>
						...
						<div class="x2">
							<div class="form-group">
								<div class="label"><label for="i_ifrec">样式</label></div>
								<div class="field">
									<label class="btn"><input name="c_bold" type="checkbox" value="font-weight: bold;" /> 粗体 </label>
									<label class="btn"><input name="c_italic" type="checkbox" value="font-style: italic;" /> 斜体 </label>
								</div>
							</div>
						</div>
						<div class="fc"></div>
						...
						<div class="x8">
							<div class="form-group">
								...
								<div class="field">
									<input id="c_picture" class="input" type="text" name="c_picture" value="" />
								</div>
						...
						<div class="x12">
							<div class="form-group">
								...
								<div class="field">
									<input id="save" class="btn bg-dot" type="submit" name="save" value="添加新信息" />
								</div>
							</div>
						</div>
						<div class="x12">
						...
						<div class="x4">
							<div class="form-group">
								...
								<div class="field">
									<textarea id="c_slide" class="input" name="c_slide"  row="5"></textarea>
						...
						<div class="x4">
							<div class="form-group">
								...
								<div class="field">
									<textarea id="c_video" class="input" name="c_video"  row="5"></textarea>
						...
						<div class="x4">
							<div class="form-group">
								...
								<div class="field">
									<textarea id="c_attach" class="input" name="c_attach"  row="5"></textarea>
						...
						<div class="x4">
							<div class="form-group">
								...
								<div class="field">
									<textarea id="c_seoname" class="input" name="c_seoname"  row="5"></textarea>
								</div>
						...
						<div class="x4">
							<div class="form-group">
								...
								<div class="field">
									<textarea id="c_keyword" class="input" name="c_keyword"  row="5"></textarea>
								</div>
						...
						<div class="x4">
							<div class="form-group">
								...
								<div class="field">
									<textarea id="c_description" class="input" name="c_description"  row="5"></textarea>
								</div>
						...
						<div class="xx20">
							<div class="form-group">
								...
								<div class="field">
									<input class="input" name="c_1" id="c_1" type="text" value="" />
								</div>
						...
						<div class="xx20">
							<div class="form-group">
								...
								<div class="field">
									<input class="input" name="c_2" id="c_2" type="text" value="" />
								</div>
						...
						<div class="xx20">
							<div class="form-group">
								...
								<div class="field">
									<input class="input" name="c_3" id="c_3" type="text" value="" />
								</div>
						...
						<div class="xx20">
							<div class="form-group">
								...
								<div class="field">
									<input class="input" name="c_4" id="c_4" type="text" value="" />
								</div>
						...
						<div class="xx20">
							<div class="form-group">
								...
								<div class="field">
									<input class="input" name="c_5" id="c_5" type="text" value="" />
								</div>
						...
						<div class="xx20">
							<div class="form-group">
								...
								<div class="field">
									<input id="c_source" class="input" name="c_source" type="text" size="60" value="未知" />
								</div>
							</div>
						</div>
						<div class="fc"></div>
						<div class="x3">
							<div class="form-group">
								...
								<div class="field">
									<label class="btn"><input name="c_rec" type="checkbox" value="1" /> 推荐 </label>
									<label class="btn"><input name="c_hot" type="checkbox" value="1" /> 热门 </label>
									<label class="btn"><input name="c_top" type="checkbox" value="1" /> 置顶 </label>
								</div>
							</div>
						</div>
					    <div class="x3">
							<div class="form-group">
								...
								<div class="field">
									<input id="c_writer" class="input" type="text" name="c_writer" value="网站管理员"  size="100"/>
								</div>
							</div>
						</div>
						<div class="x3">
							<div class="form-group">
								...
								<div class="field">
									<input id="c_hits" class="input" name="c_hits" type="text" size="60" value="0" data-validate="required:必填,plusinteger:必须为正整数" />
								</div>
							</div>
						</div>
						<div class="x3">
						...
						<div class="x3">
							<div class="form-group">
								...
								<div class="field">
									<input id="c_link" class="input" type="text" name="c_link" value=""/>
									<div class="input-note">填写后会跳转到指定地址。外链请用http://开始</div>
								</div>
							</div>
						</div>
						<div class="x2">
							...
							<div class="form-group">
								...
								<div class="field"> 
									<select id="c_enable" class="input" name="c_enable">
										<option value="1">信息发布</option>
										<option value="0">信息暂存</option>
									</select>
						...
						<div class="x3">
							<div class="form-group">
								...
								<div class="field">
								<input id="c_date" class="input laydate-icon" name="c_date" type="text" size="60" readonly="readonly" value="<%=str_time("y-mm-dd",Now())%>" onclick="laydate({istime: true, format: 'YYYY/MM/DD hh:mm:ss'})" data-validate="required:必填" />
							</div>
